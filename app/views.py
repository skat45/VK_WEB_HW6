...
def index_page(request):
    ...
    list_of_tags = get_hot_tags_list()

    return render(request, 'index.html', context={'content': content, 'hot_tags': list_of_tags})
...
def ask_page(request):
    ...
    return render(request, 'ask.html', context={'form': form, 'hot_tags': list_of_tags})
...
def login_page(request):
    ...
    return render(request, 'login.html', context={'form': form, 'user': request.user, 'hot_tags': list_of_tags})
...
def register_page(request):
    ...
    list_of_tags = get_hot_tags_list()
    return render(request, "register.html", {"form": form, 'hot_tags': list_of_tags})
...
def settings_page(request):
    ...
    list_of_tags = get_hot_tags_list()
    return render(request, 'settings.html', context={'form': form, 'hot_tags': list_of_tags})
...
def hot_questions(request):
    ...
    return render(request, "hot_questions.html", {"content": content, 'hot_tags': list_of_tags})
...
def tag(request, tag_name):
    ...
    return render(request, "questions_by_tag.html", {"tag": tag_name, "content": content,
                                                     'hot_tags': list_of_tags})
...
# Secondary functions:
def get_hot_tags_list():
    return list(Tag.objects.hot())
